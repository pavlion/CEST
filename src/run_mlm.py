...
def main():
    ...
    if data_args.dataset_name == 'yahoo_answers_topics': 
        '''
        Yahoo QA dataset
        '''
        import pickle
        ...
        datasets["validation"] = Dataset.from_pandas(test_df)
    ...
    if data_args.dataset_config_name == 'sst2': text_column_name = "sentence"
